  ...
  <div class="row-fluid">
    <div class="span12">
      ...
      <div class="block-fluid">
        ...
        <div class="row-form">
           <?php echo $this->Html->image('users/small/'.$this->data['User']['photo'], array('alt' => 'image', 'height'=>'180',  'width'=>'180'));?>
        </div>
        ...
        <div class="row-form">
          ...
          <div class="span9">
           <?php echo $this->Form->input('country_id', array('label'=>false, 'empty'=>'select country')); ?>
          </div>
          <div class="clear"></div>
        </div>
        ...
        <div class="row-form">
          ...
          <div class="span9">
           <?php echo $this->Form->input('state_id', array('label'=>false, 'onchange'=>'get_cities(this.value)', 'empty'=>'select state')); ?>
          </div>
          <div class="clear"></div>
        </div>
        ...
        <div class="row-form">
          ...
          <div class="span9" id="cityid">
           <?php echo $this->Form->input('city_id', array('options'=>$all_city, 'label'=>false, 'empty'=>'select city')); ?>
          </div>
          <div class="clear"></div>
        </div>
        ...
        <div class="row-form">
          ...
          <div class="span9">
            <?php echo $this->Form->input('joined_on', array('type'=>'text', 'label'=>false, 'class' => 'validate[required]', 'style'=>'width:80px', 'value'=>date('d-m-Y', strtotime($this->data['User']['joined_on'])))); ?>
          </div>
          <div class="clear"></div>
        </div>
