        ...
        <table cellpadding="0" cellspacing="0" width="100%" class="table" id="dailyreport-index">
          <thead>
            <tr>
              ...
              <th width="12%">Meeting Location</th>
              <th width="15%">Schedule Time</th>
              <th width="13%">Actual Time</th>
              <th width="11%">Meeting Scribe</th>
              <th width="18%">Agenda</th>
              <th width="10%">Next Meeting</th>
          ...
          <tr>
            ...
            <td>
			  <?php if($meetings[0]['Meeting']['user_id'] == $this->Session->read('User.id') && $meetings[0]['Meeting']['status'] == 0){ ?>
                <a href="<?php echo $this->base ?>/meetings/edit/<?php echo $meeting['Meeting']['id'] ?>"><span class="icon-pencil"></span></a>
              <?php } ?>
              </td>
          </tr>
          <?php } ?>
