      ...
      <div class="block-fluid">
        ...
        <div class="row-form">
          ...
          <?php $i = 0; foreach($options as $key => $value){?>
            ...
            <?php echo $this->Form->input('options', array('id'=>'checkbox-'.$key, 'type'=>'checkbox', 'name'=>'data[Email][options]['.$key.']', 'value'=>$key, 'label'=>false, 'div'=>false, 'class'=>'required')).$value; ?>
            </label>
           <?php }?>
          </div>
          <div class="clear"></div>
