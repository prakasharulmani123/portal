          ...
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="80%" align="left" valign="top"><font style="font-family: Georgia, 'Times New Roman', Times, serif; color:#010101; font-size:24px"><strong><em>Dear <?php echo $user['User']['employee_name']?>,</em></strong></font><br /><br />
                  ...
                  <?php 
				  if($status == 1){
					echo 'Your Leave Request on'.'&nbsp;'.date('d-m-Y',strtotime($leave['Leave']['date'])).' Accepted'.'<br />'.$leave['Leave']['remarks'];
				  }
				  elseif($status == 2){
					echo 'Your Leave Request on'.'&nbsp;'.date('d-m-Y',strtotime($leave['Leave']['date'])).' Declined'.'<br />'.$leave['Leave']['remarks'];
				  }
				  ?>
<br /><br />
