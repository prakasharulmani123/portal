...
<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#8d8e90">
  <tr>
    <td><table width="600" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center">
        ...
        <tr>
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="10%">&nbsp;</td>
                <td width="80%" align="center" valign="top"><font style="font-family: Georgia, 'Times New Roman', Times, serif; color:#010101; font-size:24px"><strong><em>Permission Request</em></strong></font><br /><br />
        ...
        <tr>
            ...
            Date :<?php echo ' '.date('d-m-Y', strtotime($permission['Permission']['date']))?><br />
            From : <?php echo date('h:i A', strtotime($permission['Permission']['from_time']))?> To : <?php echo date('h:i A', strtotime($permission['Permission']['to_time'])) ?><br />
            <?php
				$datetime1 = new DateTime($permission['Permission']['from_time']);
				$datetime2 = new DateTime($permission['Permission']['to_time']);
				$interval = $datetime1->diff($datetime2);
				$hours = ($interval->format('%h')*60)+($interval->format('%i'));
			?>
            Hours :<?php echo gmdate("H:i", ($hours* 60))?>
            </td>
        </tr>
        <tr>
    ...
    <br /><br />
        ...
        <tr>
            <td width="20%" align="left"><font style="font-family: Verdana, Geneva, sans-serif; color:#666766; font-size:13px; line-height:21px"><?php echo $permission['Permission']['reason']?></td>
        </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
        <tr>
            <td width="20%" align="left">
                <a href="<?php echo 'http://'.$_SERVER['HTTP_HOST']?>/portal/admin/permission" target="_blank">Click to view</a>
            </td>
        </tr>
        <tr>
