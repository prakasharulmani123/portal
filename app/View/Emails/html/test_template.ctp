...
<!--<img src="http://demo.arkinfotec.in/app/webroot/img/logo.png" height="76" width="144" alt="Sumanas Technologies"/>
...
<?php //echo $this->Html->image('logo.png', array('alt'=>'Sumanas Technologies', 'height'=>76, 'width'=>144))?>
</body>
<?php //exit;?>
