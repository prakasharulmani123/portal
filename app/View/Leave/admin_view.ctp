...
<div class="workplace">
    ...
    <div align="right" class="span12">
      <input type="button" name="back" id="back" value="Back" class="btn" onclick="location.href='<?php echo $this->base; ?>/admin/leave'" />          
    </div>
    </div>
  ...
  <div class="row-fluid">
    <div class="span12">
      ...
      <div class="block-fluid">
        ...
        <div class="row-form">
          <div class="span3">Approve:</div>
          <div class="span9">
			<?php if($leave['Leave']['approved'] == 0) {?>
                <a href="<?php echo $this->base?>/admin/leave/approve/<?php echo $leave['Leave']['id'];?>" title="Approve"><?php echo $this->Html->image('icon_' . $leave['Leave']['approved'] . '.png') ?></a> 
            <?php }
            else {
            echo $this->Html->image('icon_' . $leave['Leave']['approved'] . '.png');}?>    
         </div>
          <div class="clear"></div>
        </div>
