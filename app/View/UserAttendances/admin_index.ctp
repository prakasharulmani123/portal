...
<?php echo $this->Form->create('UserAttendance'); ?>
    <?php 
      ...
      <?php echo $this->Html->link('Reset', array('controller' => 'user_attendances', 'action' => 'reset', 'admin' => true), array('class' => 'btn btn-danger')); ?>
                    ...
                    <tbody>
                        ...
                        foreach ($attendances as $attendance):
                            ...
                            <tr>
                                ...
                                <td><?php echo $attendance['User']['employee_name']; ?></td>
