...
$( document ).ready(function() {
	<?php $current_permissions = $this->requestAction('permission/user_get_current_month_permission'); ?>
	<?php if($current_permissions >= 2){?>
	...
	$(".b_popup_4").dialog({
		...
		buttons:{                            
			"Ok": function() {
				window.location.href = '<?php echo $this->base?>/admin/leave/add';
				return false;
			},
			Cancel: function() {
	...
	$(".b_popup_3").dialog({
		...
		close: function(ev, ui) { 
			window.location.href = '<?php echo $this->base?>/admin/permission/add';
		}
...
<?php echo $this->Form->input('approved', array('type'=>'hidden', 'value'=>1)); ?>
  <div class="row-fluid">
    <div class="span12">
      <div class="head">
