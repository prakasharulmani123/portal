            ...
            <table border="1" width="100%">
                ...
                <tbody>
                    <?php foreach ($user_complaints as $user_complaint) { ?>
                        ...
                        <?php
                        $fine += $user_complaint['UserComplaint']['fine_amount'];
                    }
                    ?>
                </tbody>
            </table>
            ...
            <table border="1" width="100%">
                ...
                <tbody>
                    <?php foreach ($my_complaints as $my_complaint) { ?>
                        ...
                        <?php
                        $earnings += $my_complaint['UserComplaint']['fine_amount'];
                    }
                    ?>
                </tbody>
            </table>
				...
				<tr align=left><th>Su</th><th>M</th><th>Tu</th><th>W</th><th>Th</th><th>F</th><th>Sa</th></tr>";
                                    ...
                                    if ($check_working_day == true) {
                                        ...
                                        <tr>
                                            ...
                                            <td <?php echo $color != '' ? $color : '' ?>class="ttRC" title="<?php echo $txt ?>"><?php
                                                echo date('d-m-Y', strtotime($dailyreport));
                                                echo $check_permission == true ? '&nbsp;(Permission : ' . gmdate("H:i", ($hours * 60)) . ' hour)' : '';
                                                echo $check_leave == true ? '&nbsp;(Half a day Leave)' : ''
                                                ?></td>
                                    ...
                                    if ($check_permission == true && $permission_showed == false) {
                                        ...
                                        <tr>
                                            ...
                                            <td style="background-color:pink"class="ttRC" title="<?php echo $txt ?>"><?php
                                                echo date('d-m-Y', strtotime($dailyreport));
                                                echo '&nbsp;(Permission : ' . gmdate("H:i", ($hours * 60)) . ' hour)';
                                                ?></td>
