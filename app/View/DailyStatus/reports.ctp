...
<?php if (!$this->request->is('ajax')) { ?>
    ...
    <?php echo $this->Html->link('Reset', array('controller' => 'dailystatus', 'action' => 'report_reset'), array('class' => 'btn btn-danger')); ?>
...
<?php if (!$this->request->is('ajax')) { ?>
<?php $this->paginator->options(array('update' => '#content')); ?>
    <div class="workplace">
        <div class="row-fluid">
            <div class="span12">
                <div class="head">
        ...
        <!--        <table cellpadding="0" cellspacing="0" width="100%" class="table" id="tSortable">
                    -->          <thead>
                        <tr>
                            <th width="5%">No</th>
                            <th width="10%"><?php echo $this->paginator->sort('DailyStatus.date','Date'); ?></th>
                    ...
                    <tbody>
                        ...
                        foreach ($dailyreports as $dailyreport):
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo $this->base ?>/dailystatus/reports_view/<?php echo $dailyreport['DailyStatus']['id'] ?>" title="View Report"><span class="isb-text_document"></span></a> 
                                </td>
                            </tr>
                            <?php
                            $counter++;
                ...
                <?php
//                $this->paginator->options(array('update' => '#content', 'before' => $this->Js->get('#spinner')->effect('fadeIn', array('buffer' => false)), 'complete' => $this->Js->get('#spinner')->effect('fadeOut', array('buffer' => false))));              ;
